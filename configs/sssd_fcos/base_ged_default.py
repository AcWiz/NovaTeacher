...
from configs._base_.datasets.sparse50_ged import img_norm_cfg, dataset_type
from configs._base_.datasets.sparse50_ged import data as src_data
...
checkpoint_config = dict(by_epoch=False, interval=3200, max_keep_ckpts=30)
